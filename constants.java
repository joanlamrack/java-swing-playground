...
public class constants {
	public static final String NAME = "Erithiana Sisijoan Koesnadi";
	public static final Date BIRTHDATE = new Date(1995, 8, 9);
	public static final String OCCUPATION = "Full stack developer";
	public static final String CURRENT_WORKPLACE = "Xendit";
	public static final Object[] TABLE_HEADER = { "Symbol", "Company Name", "Price", "Change", "% Change", "Volume" };
	public static final Object[][] DATA = { { "BAC", "Bank of America Corporation", 15.98, 0.14, "+0.88%", 32157250 },
			...
			{ "PBR", "Petróleo Brasileiro S.A. - Petrobras", 6.05, -0.12, "-2.02%", 16181759 },
